...
html += "    <button class=\"ScriptHub\" onclick=\"document.write(`<script src=\'https://mmccall0813.github.io/dino.js\'></script>`)\">Dino Game<\/button><br> <button onclick='document.write(\`<style>iframe{width:100%;height:100%;position:absolute;top:0px;left:0px;border:none;}<\/style><iframe src=\"https:\/\/copterroyale.coolmathgames.com\" id=\"myFrame\" name=\"myFrame\" onload=\"injectJS()\"><\/iframe><script>function injectJS(){var iFrameHead = window.frames[\"myFrame\"].document.getElementsByTagName(\"head\")[0]; var myscript = document.createElement(\"script\"); myscript.type = \"text/javascript\"; myscript.src = \"https://mmccall0813.github.io/copterHaxTest.js\"; iFrameHead.appendChild(myscript);<\/script>\`)' class=\"ScriptHub\">Fullscreen Copter Royale (Must be on coolmath for it to work)<\/button><br><button class=\"ScriptHub\" onclick=\"remove_ads_from_free_game_pages();removePrerollAndDisplayGame()\">Coolmath Adblock (remove ads)<\/button>";
html += "  <\/div>";
