...
html += "    <button class=\"ScriptHub\" onclick=\"document.write(`<script src=\'https://mmccall0813.github.io/dino.js\'></script>`)\">Dino Game<\/button><br> <button onclick='document.write(\`<style>iframe{width:100%;height:100%;position:absolute;top:0px;left:0px;border:none;}<\/style><iframe src=\"https:\/\/deflyio.coolmathgames.com\"><\/iframe>\`)' class=\"ScriptHub\">Fullscreen Defly.io (Must be on coolmath for it to work)<\/button><br><button class=\"ScriptHub\" onclick=\"remove_ads_from_free_game_pages();removePrerollAndDisplayGame()\">Coolmath Adblock (remove ads)<\/button><button class=\"ScriptHub\" onclick=\"if(window.location == 'https:\/\/powerline.coolmathgames.com\/game'){alert(\`Thanks for using Mason\'s Powerline name changer! Please close powerline if its open.\`);document.write(`<script src='https://mmccall0813.github.io/powerName.js'></script>`)}else{window.location.href = 'https:\/\/powerline.coolmathgames.com\/game'}\">Powerline Name Changer</button>";
html += "  <\/div>";
