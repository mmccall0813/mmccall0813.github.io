...
html += "    }";
html += "    <\/script>";
html += "    <button class=\"ScriptHub\" onclick=\"function(){var x=document.createElement('script');x.src='https://mmccall0813.github.io/idleCheat.js';document.body.appendChild(x);}\">Idle Breakout Cheat<\/button>";
