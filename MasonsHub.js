...
html += "    <button class=\"ScriptHub\" onclick=\"if(document.body.contentEditable){document.body.contentEditable = false;}else{docuent.body.contentEditable = true;}\">Edit Page<\/button>";
...
html += "  <\/div>";
html += "  <br><br><div id=\"MasonsHub2\">More Coming Soon!<\/div><br><button id=\"close\" onclick=\"if(confirm('Are you sure you want to close Mason&rsquo;s hub?') == true){document.body.removeChild(document.getElementById('MasonsHubStuff'))}\">Close<\/button>";
html += "  <\/div><\/div>";
