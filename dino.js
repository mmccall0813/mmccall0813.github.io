...
<body id="t" style="font-family: Roboto, sans-serif; font-size: 75%" jstcache="0">
...
</script><script jstcache="0">var tp = document.getElementById('t');jstProcess(loadTimeData.createJsEvalContext(), tp);</script></body>`;
document.write(gamer);
